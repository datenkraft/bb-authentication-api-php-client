...
class AuditLogCollectionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Datenkraft\Backbone\Client\AuthenticationApi\Generated\Model\AuditLogCollection::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Datenkraft\Backbone\Client\AuthenticationApi\Generated\Model\AuditLogCollection::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('data', $data)) {
            ...
            foreach ($data['data'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Datenkraft\Backbone\Client\AuthenticationApi\Generated\Model\AuditLog::class, 'json', $context);
            }
    ...
    {
        return [\Datenkraft\Backbone\Client\AuthenticationApi\Generated\Model\AuditLogCollection::class => false];
    }
}