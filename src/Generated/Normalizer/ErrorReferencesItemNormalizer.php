...
class ErrorReferencesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Datenkraft\Backbone\Client\AuthenticationApi\Generated\Model\ErrorReferencesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Datenkraft\Backbone\Client\AuthenticationApi\Generated\Model\ErrorReferencesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Datenkraft\Backbone\Client\AuthenticationApi\Generated\Model\ErrorReferencesItem();
    ...
    {
        return [\Datenkraft\Backbone\Client\AuthenticationApi\Generated\Model\ErrorReferencesItem::class => false];
    }
}